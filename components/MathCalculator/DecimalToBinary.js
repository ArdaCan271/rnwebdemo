...
function decimalToBinary(decimalNumber) {
  if (decimalNumber < 0 || !Number.isInteger(decimalNumber)) {
    ...
    while (decimalNumber > 0) {
      ...
      binaryDigits.unshift(remainder); // add remainder to the beginning of the array
      decimalNumber = Math.floor(decimalNumber / 2); // integer division by 2
    }
...
const DecimalToBinary = () => {
  ...
  const onCalculateClick = () => {
    setResult("Binary: " + decimalToBinary(parseInt(num)));
  }
