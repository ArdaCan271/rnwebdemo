...
function calculateDailyProtein(weight, activityLevel) {
  switch (activityLevel) {
    ...
    case 'very active':
      return (weight * 1.4).toFixed(2);
    case 'extra active':
      return (weight * 1.6).toFixed(2);
  }
}
...
const CalculateDailyProtein = () => {
  ...
  const onCalculateClick = () => {
    setResult("Your ideal daily protein intake: " + calculateDailyProtein(parseFloat(weight), selectedLevel) + " grams");
  }
...
export default CalculateDailyProtein;