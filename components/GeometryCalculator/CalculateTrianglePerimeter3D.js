...
function perimeterOfTriangle(x1, y1, z1, x2, y2, z2, x3, y3, z3) {
  const a = distanceBetweenPoints(x1, y1, z1, x2, y2, z2);
  const b = distanceBetweenPoints(x2, y2, z2, x3, y3, z3);
  const c = distanceBetweenPoints(x3, y3, z3, x1, y1, z1);
  return a + b + c;
}


const CalculateTrianglePerimeter3D = () => {
  ...
  const onCalculateClick = () => {
    setResult("Perimeter: " + perimeterOfTriangle(parseFloat(x1), parseFloat(y1), parseFloat(z1), parseFloat(x2), parseFloat(y2), parseFloat(z2), parseFloat(x3), parseFloat(y3), parseFloat(z3)));
  }
...
export default CalculateTrianglePerimeter3D;