...
// Calculates the perimeter of a triangle given its three corner points
function calculateTrianglePerimeter(x1, y1, x2, y2, x3, y3) {
...
const CalculateTrianglePerimeter = () => {
  ...
  const onCalculateClick = () => {
    setResult("Perimeter: " + calculateTrianglePerimeter(parseFloat(x1), parseFloat(y1), parseFloat(x2), parseFloat(y2), parseFloat(x3), parseFloat(y3)));
  }
...
export default CalculateTrianglePerimeter;